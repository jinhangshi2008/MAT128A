function Jin_Hangshi_splineplot(x,y)
%
% This program draws the graph for natural cubic splines for each interval.
%
% Inputs:
%
...
for i=1:n-1
    ...
    plot(linspace(x(i),x(i+1)),subs(s{i},q,linspace(x(i),x(i+1))))
    hold on;
                                    %Plot the natural cubic splines on one
                                    %figure
end
end